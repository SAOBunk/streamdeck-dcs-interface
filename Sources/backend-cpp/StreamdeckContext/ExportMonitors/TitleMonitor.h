...
class TitleMonitor
{
  ...
  private:
    ...
    std::string string_monitor_format_raw_;     //Store the raw string entered for use with formatting.
    float string_monitor_format_multiplier_ = 1;//Default multiplier value for use with formatting
    float string_monitor_format_offset_ = 0;    //Default offset value for use with formatting
